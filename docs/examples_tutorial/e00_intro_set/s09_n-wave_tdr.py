...
def n_wave_period_center(intro_s: float, n_wave_duration_s: float, outro_s: float, sample_rate_hz: float) -> \
    ...
    p_n_wave[sigint1] = (1. - 2*(time_s[sigint1]-intro_s)/n_wave_duration_s)

...
if __name__ == "__main__":
    ...
    (
        welch_power,
        welch_power_per_band,
        welch_power_per_sample,
        welch_power_total,
        welch_power_scaled,
        welch_information_bits,
        welch_information_bits_per_band,
        welch_information_bits_per_sample,
        welch_information_bits_total,
        welch_information_scaled,
